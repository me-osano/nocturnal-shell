...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    mkdir -p $out/share/nocturnal-shell $out/bin
    cp -r . $out/share/nocturnal-shell
    ln -s ${quickshell}/bin/qs $out/bin/nocturnal-shell
  '';
  ...
  preFixup = ''
    qtWrapperArgs+=(
      ...
      --add-flags "-p $out/share/nocturnal-shell"
  ...
  meta = {
    ...
    homepage = "https://github.com/me-osano/nocturnal-shell";
    license = lib.licenses.mit;
    mainProgram = "nocturnal-shell";
  };
}
