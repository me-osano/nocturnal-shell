...
SmartPanel {
  ...
  panelContent: Rectangle {
    ...
    readonly property string subtitleText: hasPreviousVersion ? "Updated from {previousVersion}" : "Thanks for installing Nocturnal! Here is what’s included in this build."
