  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      ColumnLayout {
        ...
        NText {
          text: "Set the mood with a beautiful background."
  ...
  Rectangle {
    ...
    RowLayout {
      ...
      ColumnLayout {
        ...
        spacing: Style.marginXS
        NText {
          text: filteredWallpapers.length === 0 && selectedDirectory !== "" ? "No wallpapers found in directory" : "No wallpaper directory selected"
          pointSize: Style.fontSizeM
          font.weight: Style.fontWeightBold
          color: Color.mOnSurfaceVariant
        }
        NText {
          text: selectedDirectory !== "" ? "No valid image files found in: {dir}" : "Choose a directory containing your wallpaper images"
          pointSize: Style.fontSizeS
          color: Color.mOnSurfaceVariant
