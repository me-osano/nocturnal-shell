...
ColumnLayout {
  ...
  RowLayout {
    ...
    ColumnLayout {
      ...
      NText {
        text: "Choose Dark Mode and color sources (wallpaper or predefined)."
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        ColumnLayout {
          ...
          NText {
            text: "Switches to a darker theme for easier viewing at night."
      ...
      RowLayout {
        ...
        ColumnLayout {
          ...
          NText {
            text: "Generate color schemes from your wallpaper. Automatically extracts colors to create a cohesive theme."
            pointSize: Style.fontSizeS
            color: Color.mOnSurfaceVariant
            wrapMode: Text.WordWrap
            Layout.fillWidth: true
