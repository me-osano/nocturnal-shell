...
ColumnLayout {
  ...
  NHeader {
    description: root.supporters.length === 0 ? "Loading supporters..." : ((root.supporters.length) == 1 ? "A huge thank you to our amazing supporter!" : "A huge thank you to our <b>{count} amazing</b> supporters!")
