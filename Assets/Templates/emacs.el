;;; nocturnal-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme nocturnal "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'nocturnal)
;;; nocturnal-theme.el ends here
