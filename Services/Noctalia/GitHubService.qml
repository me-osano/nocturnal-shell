...
Singleton {
  ...
  property string githubDataFile: Quickshell.env("NOCTURNAL_GITHUB_FILE") || (Settings.cacheDir + "github.json")
  ...
  Process {
    ...
    command: ["curl", "-s", "https://api.github.com/repos/me-osano/nocturnal-shell/releases/latest"]
  ...
  Process {
    ...
    command: ["curl", "-s", "https://api.github.com/repos/me-osano/nocturnal-shell/contributors?per_page=100"]
